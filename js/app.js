...
"" == path && (path = "index.php");
var target = $('.page-header .navigation .nav-primary li a[href="' + path + '"],.navigation-nav .navigation-list li a[href="' + path + '"]');
target.addClass("active");
$(".navigation-btn").on("click", function () {
    $("body").toggleClass("menu-active")
});
$("body").prepend('<div id="cursor"><div class="cursor__circle"></div></div>');
