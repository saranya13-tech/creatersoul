    ...
    <div class="o-scroll" id="js-scroll" data-scroll-container>
        ...
        <main>
            <div class="page-title">
                <div class="container">
                    <h1>In <b>need</b> for design? <span>Write Us</span></h1>
                </div>
            </div>
                        ...
                        <div class="col-lg-6 order-sm-1">
                            <div class="form-section">
                                <form id="contact-form" method="post">
                                    ...
                                    <textarea rows="6" placeholder="Write text here..." id="message" name="message"
                                        required></textarea>
                                    <button type="submit" id="submit" name="submit" cursor-class="arrow"
                                        class="btn">Let's talk</button>
                                </form>
                                <div id="error"></div>
